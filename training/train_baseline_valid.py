...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--train-csv", type=Path, default="training/new_csvs/florence_lopfo/heldout_fp1/train.csv")
    parser.add_argument("--val-csv", type=Path, default= "training/new_csvs/florence_lopfo/heldout_fp1/val.csv")
    parser.add_argument("--test-csv", type=Path, default="training/new_csvs/florence_lopfo/heldout_fp1/test.csv")
    ...
    parser.add_argument("--run-name", default="unet_baseline_milton_pretraining_20_epoch")
