...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--test-csv", type=Path, default="training/fine_tune_csvs/flood_bin_csv_splits/milton_test_10-25.csv")
    ...
    parser.add_argument("--run-name", default="ssl_no_loca_milton_testing_high_flood")
    ...
    parser.add_argument(
        "--encoder-lr-scale", type=float, default= 100,
