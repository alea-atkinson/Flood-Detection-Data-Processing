...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--train-csv", type=Path, default="training/fine_tune_csvs/pretrain_weak/train.csv")
    parser.add_argument("--val-csv", type=Path, default= "training/fine_tune_csvs/pretrain_weak/val.csv")
    parser.add_argument("--test-csv", type=Path, default="training/fine_tune_csvs/no_overlap_converted/held_out_fp1_test.csv")
    ...
    parser.add_argument("--run-name", default="unet_baseline_weak_pretrain_20_epoch")
