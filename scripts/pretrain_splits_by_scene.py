...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--train-csv", type=Path, default="training/pretrain_csvs_new/train.csv")
    parser.add_argument("--val-csv", type=Path, default="training/pretrain_csvs_new/val.csv")
